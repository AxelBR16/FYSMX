                ...
                <li>
                    ...
                    <ul class="sub-menu">
                        ...
                        <option value="0">Carrera</option>
                                ...
                                <option value="3">Inteligencia Estrategica</option>
                                ...
                                <option value="9">Contaduria</option>
                                <option value="10">Construccion</option>
                                <option value="11">Idiomas</option>
                                <option value="12">Odontologia</option>
                                <option value="13">Pedagogia</option>
                                <option value="14">Diseño de Modas</option>
                                <option value="15">Computacion</option>
                                <option value="16">Cinematografia</option>
                                <option value="17">Mecatronica</option>
                                <option value="18">Criminologia</option>
                                <option value="19">Historia</option>
                                <option value="20">Gastronomia</option>
                                <option value="21">Turismo</option>
                                <option value="22">Biologia</option>
                                <option value="23">Animacion</option>
                                <option value="24">Comunicacion</option>
                                <option value="25">Teologia Biblica</option>
                            </select> 
                        </li>
                    </ul>
                </li>
