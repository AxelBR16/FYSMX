<?php
  ...
  $db = new Database();
  $con = $db->conectar();
  $sql = $con->prepare('SELECT id, nombre, precio, codigoPostal, codigoPostal FROM licenciaturas');
  $sql->execute();
...
<body>
    ...
    <div class="contenedor barra sticky">
        ...
        <nav class="navegacion">
                ...
                <a class="text-center iconoText navegacion__enlace" href="escuela.html">
    ...
    <div class="contenedor-escuelas">
        <div class="contenedor-escuelas__navegacion">
                ...
                <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
                  ...
                  <div class="col">
                    <div class="card shadow-sm">
                       <img class="img-fluid" src="/img/etac.webp" alt="universidad1">
                      <div class="card-body">
                        <h4 class="centrar-texto">Carrera 1</h4>
                        <small class="text-muted">ETAC</small>
                        <br>
                        <small class="text-muted">$2.500</small>
                        <br>
                        <small class="text-muted">CP: 06920</small>
                        <br>
                        <div class="text-end">
            ...
            <div class="contenedor-footer">
                ...
                <section class="f-contactos">
                    ...
                    <div class="con">
                        ...
                        <div class="f-text">
                            <p><a href="#">correo@correo.com</a></p>
                        </div>
                ...
                <section class="f-sobre--comp">
                    <h2 class="no-margin">Sobre la compania</h2>
                    <div class="f-text">
                        <P>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Placeat ut autem, 
                            molestiae dolores, aperiam possimus repellat numquam, illum blanditiis nulla 
                            doloremque nemo suscipit dolorum adipisci eaque aut voluptatibus reprehenderit 
                            maxime.</P>
                    </div>
                    ...
                    <div class="redes">
                        ...
                        <a href="#">
                            <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-brand-x" width="40" height="40" viewBox="0 0 24 24" stroke-width="1.5" stroke="#ffffff" fill="none" stroke-linecap="round" stroke-linejoin="round">
